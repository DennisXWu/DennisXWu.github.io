...
​       我们可以把Lambda表达式理解为简洁的表示可传递的匿名函数的一种方式：它没有名称，但它有**参数列表、函数主题、返回类型**，可能还有一个可抛出的异常列表。
   ...
   ![](../assets/images/img/java/1.1.png)
...
​     ![](../assets/images/img/java/1.2.png)


​     ![](../assets/images/img/java/1.3.png)
...
​        ![](../assets/images/img/java/1.4.png)
...
​       ![](../assets/images/img/java/1.5.png)
...
​         ![](../assets/images/img/java/1.6.png)
